...
<?php
    ...
    // echo $sql;
    // 출력 결과 : SELECT b.myBoardID, b.boardTitle, b.boardContents, m.youName, b.regTime, b.boardView FROM myBoard b JOIN myMember m ON(b.myMemberID = m.myMemberID)WHERE b.boardTitle LIKE '%게시판%' ORDER BY myBoardID DESC
...
<?php
    ...
    for($i=$startPage; $i<=$endPage; $i++){
        ...
        echo "<li ><a class='{$active}' href='boardSearch.php?page={$i}&searchKeyword={$searchKeyword}&searchOption={$searchOption}'>{$i}</a></li>";
    }
